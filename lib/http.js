  ...
  app.post(
    ...
    _createAuthorizeMiddleware({
      ...
      getRootController({req}) {
        // root controller for updating meter config is always the controller of
        // the meter
    ...
    asyncHandler(async (req, res) => {
      ...
      if(meter.id) {
        // remove meter id to prevent overwriting the original
        delete meter.id;
      }
      ...
      while(attempts < maxRetries) {
        try {
          ...
          // break out of the loop if the meter was successfully updated
